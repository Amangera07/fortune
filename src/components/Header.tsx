...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    hasDropdown: true,
    dropdownItems: [
      { label: "BAKERY", href: "/shop/bakery", hasArrow: true },
      { label: "CONFECTIONERY", href: "/shop/confectionery", hasArrow: true },
      { label: "DAIRY", href: "/shop/dairy", hasArrow: true },
      { label: "MEATS", href: "/shop/meats", hasArrow: true },
      { label: "POULTRY", href: "/shop/poultry", hasArrow: true },
    ],
  },
  {
    name: "Shop",
  ...
  },
  {
    ...
    hasDropdown: true,
    dropdownItems: [
      { label: "Clients", href: "/community/clients" },
