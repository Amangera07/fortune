...
// ─── Salumi Charcuterie Product Data ──────────────────────────────────────────
const PRODUCTS = [
  { 
    id: 1, 
    name: "Antipasto classico 120g", 
    tags: "ITALY, MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP", 
    img: "/assets/4.jpg" 
  },
  { 
    id: 2, 
  ...
  { 
    id: 3, 
    name: "Prosciutto Crudo 100gm", 
    tags: "ITALY, MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP", 
    img: "/assets/6.jpg" 
  },
  { 
    id: 4, 
    name: "Prosciutto Crudo Full", 
    tags: "ITALY, MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP", 
    img: "/assets/7.jpg" 
  },
  { 
    id: 5, 
    name: "Prosciutto di Parma 80 g", 
    tags: "ITALY, MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP", 
    img: "/assets/8.jpg" 
  },
  { 
    id: 6, 
    name: "Salami Milano 100gm", 
    tags: "ITALY, MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP", 
    img: "/assets/9.jpg" 
  },
  { 
    id: 7, 
    name: "Salami Napoli 100gm", 
    tags: "ITALY, MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP", 
    img: "https://fortunegourmet.com/wp-content/uploads/2025/03/SALAME-NAPOLI-100g-verticale-AP-600x600.jpg" 
  },
  { 
    id: 8, 
    name: "Streaky bacon 150 gm", 
    tags: "MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP, SRI LANKA", 
    img: "https://fortunegourmet.com/wp-content/uploads/2025/03/sb150gm-600x600.png" 
  },
  { 
    id: 9, 
    name: "Streaky Bacon 1kg", 
    tags: "MEATS, PORK, SALUMI & CHARCUTERIE, SALUMI CHARCUTERIE, SHOP, SRI LANKA", 
    img: "https://fortunegourmet.com/wp-content/uploads/2025/03/Streaky-bacon-1kg-600x600.jpg" 
  },
];

export default function SalumiCharcuteriePage() {
      ...
      <section className="relative w-full min-h-[80vh] md:min-h-[120vh] lg:min-h-[160vh] flex items-center">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-full lg:w-[70%] h-full opacity-50 lg:opacity-90">
            {/* Same generic dark background image that fits perfectly with the aesthetic */}
            <img src="/assets/banner-img-dark.png" alt="Salumi Charcuterie Background" className="w-full h-full object-cover object-right" />
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full" style={{ paddingTop: "100px", paddingBottom: "160px" }}>
          <div ref={heroTextRef} className="max-w-2xl relative z-10">
            ...
            <p className="font-royal-sans text-white text-xl sm:text-2xl max-w-md leading-relaxed font-light drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              Bringing You the Finest Selection<br/> of Premium Cured Meats
            </p>
      ...
      <section className="bg-[#163527] py-10 px-6 relative z-10 border-t-4 border-[#fdb833]">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center text-center gap-3">
            ...
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">Premium<br/>Selection</p>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#fdb833]/40 flex items-center justify-center text-[#fdb833]">
              <span className="text-xl">🧂</span>
            </div>
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">Authentically<br/>Cured</p>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#fdb833]/40 flex items-center justify-center text-[#fdb833]">
              <span className="text-xl">🌍</span>
            </div>
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">Imported<br/>Globally</p>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#fdb833]/40 flex items-center justify-center text-[#fdb833]">
              <span className="text-xl">🚚</span>
