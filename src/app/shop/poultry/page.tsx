...
// ─── Poultry Shop Product Data (From Fortunegourmet Live Site) ─────────────────
const PRODUCTS = [
  {
    id: 1,
    name: "Chicken Breakfast Sausage",
    tags: "CHICKEN, INDIA, POULTRY, POULTRY, SHOP",
    img: "https://fortunegourmet.com/wp-content/uploads/2025/03/cbs-600x600.jpg",
  },
  {
    id: 2,
    name: "Chicken Frankfurter 500gm",
    tags: "CHICKEN, INDIA, POULTRY, POULTRY, SHOP",
    img: "https://fortunegourmet.com/wp-content/uploads/2025/03/cf-1kg-600x600.jpg",
  },
  {
    id: 3,
    name: "Chicken Lemon Pepper Salami 500gm",
    tags: "CHICKEN, INDIA, POULTRY, POULTRY, SHOP",
    img: "https://fortunegourmet.com/wp-content/uploads/2025/03/Chicken-Lemon-Pepper-Salami-600x600.jpg",
  },
];
...
export default function PoultryPage() {
  ...
  return (
    <main className="min-h-screen bg-[#fbe8c3] text-neutral-900 font-sans overflow-x-hidden">
      ...
      {/* ── HERO BANNER (160vh matching dairy & salumi) ────────────────────────── */}
      <section className="relative w-full min-h-[160vh] flex items-center">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-0 right-0 w-full lg:w-[70%] h-full opacity-50 lg:opacity-90">
            <img 
              src="/assets/banner-img-dark.png" 
              alt="Poultry Background" 
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full" style={{ paddingTop: "100px", paddingBottom: "160px" }}>
          <div ref={heroTextRef} className="max-w-2xl relative z-10">
            <h1 className="font-royal-cinzel font-bold uppercase text-5xl sm:text-6xl md:text-7xl lg:text-[72px] text-[#fdb833] leading-none mb-6 drop-shadow-[0_4px_24px_rgba(0,0,0,0.8)]">
              Poultry
            </h1>
            <p className="font-royal-sans text-white text-xl sm:text-2xl max-w-md leading-relaxed font-light drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              Finest Selection of Farm-Fresh<br /> & Artisanal Poultry Cuts
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="product-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
            {PRODUCTS.map((product) => (
              <div 
                key={product.id} 
                className="product-card bg-white rounded-xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)] transition-all duration-500 group flex flex-col border border-black/5 hover:border-[#fdb833]/40 transform hover:-translate-y-1"
              >
      ...
      <section className="bg-[#163527] py-10 px-6 relative z-10 border-t-4 border-[#fdb833]">
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="flex flex-col items-center text-center gap-3">
            ...
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">Farm Fresh<br />Poultry</p>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#fdb833]/40 flex items-center justify-center text-[#fdb833]">
              <span className="text-xl">🌿</span>
            </div>
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">100% Pure<br />& Natural</p>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#fdb833]/40 flex items-center justify-center text-[#fdb833]">
              <span className="text-xl">🛡️</span>
            </div>
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">Hygienically<br />Handled</p>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 rounded-full border border-[#fdb833]/40 flex items-center justify-center text-[#fdb833]">
              <span className="text-xl">🚚</span>
            </div>
            <p className="font-royal-sans text-white text-sm font-medium leading-tight">Temperature<br />Controlled</p>
          </div>
        </div>
      </section>
