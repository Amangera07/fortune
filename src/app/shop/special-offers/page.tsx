...
const PRODUCTS = [
  {
    id: 1,
    name: "Chèvre Goat Cheese Special Offer – Buy 1, Get 1 FREE!",
    tags: "SHOP, SPECIAL OFFERS",
    img: "/assets/special-offer-1.jpg"
  },
  {
    id: 2,
    name: "Lactima Cheese Portions 120g – Special Offer – Buy 1, Get 2 FREE!",
    tags: "SHOP, SPECIAL OFFERS",
    img: "/assets/special-offer-2.jpg"
  },
  {
    id: 3,
    name: "Lurpak Butter Special Offer – Buy More, Save More!",
    tags: "SHOP, SPECIAL OFFERS",
    img: "/assets/special-offer-3.jpg"
  },
];
...
export default function SpecialOffersPage() {
  ...
  return (
    <main className="min-h-screen bg-[#fbe8c3] text-neutral-900 font-sans overflow-x-hidden flex flex-col">
      ...
      <section className="relative w-full min-h-[80vh] md:min-h-[120vh] lg:min-h-[160vh] flex items-center">
        <div className="absolute inset-0 z-0">
          ...
          {/* Image faded on the right to match layout without breaking the full-bleed feel */}
          <div className="absolute top-0 right-0 w-full lg:w-[70%] h-full opacity-50 lg:opacity-90">
            <Image src="/assets/banner-img-dark.png" alt="Offers Background" fill className="object-cover object-right" priority />
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_60%,rgba(253,184,51,0.15)_0%,transparent_70%)]" />
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full flex " style={{ paddingTop: "100px", paddingBottom: "160px" }}>
          <div ref={heroTextRef} className="max-w-3xl flex flex-col relative z-10">
            <h1 className="font-royal-cinzel font-bold uppercase text-4xl sm:text-5xl md:text-6xl lg:text-[72px] text-[#fdb833] leading-none mb-6 drop-shadow-[0_4px_24px_rgba(0,0,0,0.8)]">
              Special Offers
            </h1>
            <p className="font-royal-sans text-white text-lg sm:text-xl max-w-lg leading-relaxed font-light drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
              Exclusive Deals & Irresistible Gourmet Offers on World-Class Delicacies
            </p>
      ...
      {/* ── PRODUCT SECTION ────────────────────────────────────────────────────── */}
      <section className="bg-[#fbe8c3] relative -mt-32 pt-32 pb-24 px-6 sm:px-10 z-0 flex-1">
